package com.iiht.training.testutils;
...
public class TestUtils {
	...
	/*
	 * public static final String TEXT_RESET = ""; public static final String
	 * RED_BOLD_BRIGHT = ""; // RED public static final String GREEN_BOLD_BRIGHT =
	 * ""; // GREEN public static final String YELLOW_BOLD_BRIGHT = "";// YELLOW
	...
	static {
		...
		xmlFile = new File("./Java-Core-Multifile-D.xml");
		xmlFile.delete();
